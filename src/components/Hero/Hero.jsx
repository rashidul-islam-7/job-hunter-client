  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-8 md:px-16 py-10 md:py-16">
      ...
      <div className="flex  items-center justify-center">
        <span className="h-0.5 w-15 bg-linear-to-l to-black-500 from-gray-400 " />
        <div className="flex items-center gap-2 px-5 py-1 rounded-full bg-gray-800 w-fit">
      ...
      {/* tags  */}
      <div className="flex justify-center items-center gap-5 mt-4 flex-wrap">
